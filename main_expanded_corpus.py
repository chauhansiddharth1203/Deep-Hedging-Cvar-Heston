...
------------------------
: direct test of the regime-coverage
hypothesis.

claimed the sim-to-real failure decomposes into:
...
def write_metrics(res, path):
 ...
 f.write("-- Expanded training corpus (SPY 2005-2020)\n")
 f.write("=" * 72 + "\n\n")
...
def plot_cvar_bars(res, path):
 ...
 ax.set_title(": Expanded corpus -- direct test of the regime-coverage hypothesis")
