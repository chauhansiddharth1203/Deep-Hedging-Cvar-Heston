...
---------------------------
Ablation A: Mean-CVaR trade-off.
...
Loss:
 ...
 - lambda = 0 : pure CVaR (baseline -- may speculate)
...
on the two-asset Heston model (same setup as ) and report mean,
...
def main():
 ...
 f.write("-- Mean-CVaR trade-off ablation\n")
 f.write("=" * 60 + "\n")
