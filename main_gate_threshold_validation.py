...
-----------------------------------
Step 1 of the post-training roadmap: principled gate threshold selection.
...
-----
 ...
 w = 0.3 (frozen, same as )
 5 seeds per theta
 400 epochs per seed (same as )
...
# Pre-registered COVID constraint (same as )
...
def main():
 ...
 # Pre-registered 2024 pass criterion (same as )
