...
main_vix_futures.py
--------------------
: VIX-as-vega, weekly rebalancing.

Tests the hypothesis: the residual COVID hedge failure is
...
def write_metrics(res, history, path):
 ...
 f.write("-- VIX-as-vega, weekly rebalancing\n")
 f.write("=" * 72 + "\n\n")
...
def plot_learning(history, path):
 ...
 ax.set_title(": VIX-as-vega, weekly rebalancing -- learning curve")
...
def plot_cvar(res, path):
 ...
 ax.set_title(": VIX-as-vega vs Black-Scholes delta (weekly rebalance)")
