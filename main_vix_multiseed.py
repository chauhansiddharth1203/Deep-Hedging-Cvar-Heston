...
----------------------
: multi-seed verification of Sprint 2b.
...
Decision rule (pre-registered before looking at results):
 ...
 - Otherwise: hypothesis not supported; pivot to Neural SDE.
"""
...
def main():
 ...
 f.write(f"-- Multi-seed verification of Sprint 2b\n")
 f.write("=" * 72 + "\n")
 ...
 ax.set_title(f": Multi-seed verification "
 ...
 print("\n>>> BOTH criteria met -> declare hypothesis supported.")
 elif win_2024 or closure_covid:
 print("\n>>> Mixed: one criterion met. Report as weak evidence.")
 else:
 print("\n>>> Neither criterion met -> hypothesis not supported. "
 "Pivot to Neural SDE.")
