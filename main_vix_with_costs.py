...
-----------------------
Step 2 of the post-training roadmap: VIX futures with realistic
bid-ask transaction costs on the VIX leg.

MOTIVATION
----------
Every real-data result in Sprints 2-3 and uses VIX as a
...
SPREAD LEVELS SWEPT
-------------------
 0.00 VIX pts -> baseline (no extra VIX cost, matches )
