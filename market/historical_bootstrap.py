...
-------------------------------
: Stationary block-bootstrap simulator for training on real SPY
...
Match to simulator interface:
 simulate_historical(N, device) -> (S, VS, payoff_fn, meta)

Variance-swap proxy:
 Same EWMA(lambda=0.94) x 252 annualisation as historical stress
