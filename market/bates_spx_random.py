...
---------------------------
Combined simulator for the sim-to-real sprint.
...
This addresses the historical-stress finding that policies trained
...
Variance-swap convention (fixed scaling, as in robust training):
