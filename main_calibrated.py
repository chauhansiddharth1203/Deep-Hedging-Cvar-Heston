...
main_calibrated.py
------------------
Experiment A: SPX-calibrated Heston parameters.

Tests whether the finding (variance swap beats delta hedge) holds
...
# ------------------------------------------------------------------ #
# 1. Load policy (trained on textbook Heston) #
# ------------------------------------------------------------------ #
print("Loading policy (trained on textbook Heston params) ...")
