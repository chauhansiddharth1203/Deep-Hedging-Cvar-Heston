...
main_bates.py
-------------
main experiment: Bates model (Heston + Poisson jumps).
...
# ------------------------------------------------------------------ #
# Load pre-saved Heston PnL tensors from heston_results_available = all(
 os.path.exists(p)
...
if heston_results_available:
 ...
 print("\nNote: Heston PnL files not found; skipping Heston vs Bates comparison plot.")
