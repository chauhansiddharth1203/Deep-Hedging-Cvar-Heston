...
data/vix_windows.py
--------------------
: Joint SPY + VIX weekly data loader.

The diagnosis isolated the remaining sim-to-real failure to
the interaction between daily rebalancing and a lagging EWMA variance
proxy. replaces the EWMA-VS with the VIX index itself, used
...
Train: 2005-01-01 -> 2020-12-31 (as in , COVID in-training)
